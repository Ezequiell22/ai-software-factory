...
class Settings(BaseSettings):
    ...
    jira_ux_issue_type: str = "Subtask"
    jira_issue_link_type: str = "Relates"
    jira_agent_status: str = "Discovery"
    jira_human_status: str = "Human Approval"
    jira_story_status: str = "Specification"
    jira_ux_status: str = "UX/UI"
    jira_ready_status: str = "Engineering Ready"
